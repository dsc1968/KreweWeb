...
const { post__api_auth_register_request_code, post__api_auth_register_verify_code, post__api_auth_login, get__api_profile, put__api_profile_details, get__api_members, get__api_mfa_policy, post__api_auth_mfa_send, post__api_auth_mfa_verify, put__api_profile_mfa } = require('../controllers/authController');
