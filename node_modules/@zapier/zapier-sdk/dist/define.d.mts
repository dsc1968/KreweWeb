...
interface CallbackOptionsWithTimeout<T = unknown> extends CallbackOptions<T> {
...
interface DurableContext extends DefineContext {
    ...
    createCallback<T>(options: CallbackOptionsWithTimeout<T>): Promise<[Promise<CallbackResult<T>>, string]>;
