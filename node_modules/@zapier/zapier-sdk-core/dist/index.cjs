...
var AuthenticationSchema = import_zod.z.object({
  ...
  slug: import_zod.z.string().nullable().optional().describe(
    "Human-readable app slug for this authentication's integration (e.g. 'google-sheets'). Null when no slug is registered for the app."
  ),
