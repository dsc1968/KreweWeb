...
var _tollfree_verification = require('../resources/tollfree_verification.js');

var _verifyCallerId = require('../resources/verifyCallerId');

var _phoneNumberCompliance = require('../resources/phoneNumberCompliance');
...
var Client = exports.Client = function Client(authId, authToken, proxy) {
  ...
  this.tollfreeVerification = new _tollfree_verification.TollfreeVerificationInterface(client);
  this.verify = new _verifyCallerId.VerifyInterface(client);
  this.phoneNumberCompliance = new _phoneNumberCompliance.PhoneNumberComplianceInterface(client);
  this.phoneNumberComplianceRequirements = new _phoneNumberCompliance.PhoneNumberComplianceRequirementInterface(client);
  this.phoneNumberComplianceLink = new _phoneNumberCompliance.PhoneNumberComplianceLinkInterface(client);
};
