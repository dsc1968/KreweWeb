...
var ProfileInterface = exports.ProfileInterface = function (_PlivoResource2) {
    ...
    _createClass(ProfileInterface, [{
        ...
        key: 'create',
        value: function create(profile_alias, plivo_subaccount, customer_type, entity_type, company_name, ein, vertical, ein_issuing_country, stock_symbol, stock_exchange, alt_business_id_type, website, address, authorized_contact, business_contact_email, doing_business_as) {
            var params = {};
